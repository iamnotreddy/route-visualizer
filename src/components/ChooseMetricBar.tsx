  ...
  const heroIconPaths: Icon[] = [
    {
      ...
      baseClass:
        'h-5 w-5 fill-slate-300 stroke-zinc-700 stroke-2 hover:scale-150 hover:fill-pink-300',
      selectedClass:
        'h-7 w-7 fill-pink-300 stroke-zinc-700 stroke-2 hover:scale-150',
    },
    {
      name: 'pace',
      ...
      baseClass:
        'h-5 w-5 fill-slate-300 stroke-zinc-700 stroke-2 hover:scale-150 hover:fill-emerald-600',
      selectedClass:
        'h-7 w-7 fill-emerald-600 stroke-zinc-700 stroke-2 hover:scale-150',
    },
    ...
    },
    {
      ...
      baseClass:
        'h-5 w-5 fill-slate-300 stroke-zinc-700 stroke-2 hover:scale-150 hover:fill-amber-500',
      selectedClass:
        'h-7 w-7 fill-amber-500 stroke-zinc-700 stroke-2 hover:scale-150',
    },
  ];
